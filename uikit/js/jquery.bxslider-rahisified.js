...
(function($){
     ...
     * ===================================================================================
      ...
      if(slider.settings.breaks) {
        ...
        if(slider.settings.fullscreen) {
          ...
          slider.settings.slideWidth = fullWidth;
        }
		/**
		 * ===================================================================================
      ...
      if(sliderW <= 400) {
        ...
        relSize = "size-sm";
      } else if (sliderW > 767 && sliderW <= 1023) {
        relSize = "size-md";
      } else {
        relSize = "size-lg";
      }
      ...
      el.attr("data-bxinit", "true");
      // play start slides anims
    ...
    function playAnims(slide) {
      ...
      $(slide).find(".bx-layer").each(function(index) {
        var dur = parseInt($(this).attr("data-dur"));
        var delay = parseInt($(this).attr("data-delay"));
        durCol[index] = dur + delay;
        var anim = $(this).attr("data-anim");
